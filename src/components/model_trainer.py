...
class ModelTrainer:
    def __init__(self):
        ...
        self.models = {
            ...
            'GradientBoosterClassifier': GradientBoostingClassifier(),
            'SVC': SVC(),
    ...
    def initiate_model_trainer(self, train_array, test_array):
        ...
        try:
            ...
            best_model = self.finetune_best_model(
                best_model_name=best_model_name, best_model_object=best_model, X_train=x_train, y_train=y_train
            )
            ...
            print(
                f"best model name {best_model_name} and score: {best_model_score}"
            )

            if best_model_score < 0.5:
                raise Exception(
                    "No best model found with an accuracy greater than the threshold 0.6"
                )
